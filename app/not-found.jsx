...
export default function Example() {
    return (
        <div className="flex h-screen text-white flex-col items-center justify-center text-sm max-md:px-4">
            ...
            <p className="text-2xl md:text-3xl font-bold text-gray-200">Page Not Found</p>
            ...
            <div className="flex items-center gap-4 mt-6">
                ...
                <a href="/support" className="border border-gray-300 px-7 py-2.5 text-gray-200 rounded-md active:scale-95 transition-all">
                    Contact support
                </a>
            </div>
        </div>
