  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-7xl mx-auto px-6 py-16">
        {/* Header Section */}
        <div className="mb-12">
          <p className="text-gray-400 text-sm mb-4 tracking-wide">About Our Company</p>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className={`${services[0].bgColor} rounded-3xl p-8 border border-gray-800`}>
          ...
          {/* Content Strategy */}
          <div className={`${services[1].bgColor} rounded-3xl p-8 border border-gray-800`}>
          ...
          {/* Business Scaling */}
          <div className={`${services[2].bgColor} rounded-3xl p-8 border border-gray-800 lg:col-span-2`}>
